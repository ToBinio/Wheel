 ...
 */
public class WidgetLoader extends JsonDataLoader<Widget> {
    ...
    private WidgetLoader() {
        super(Widget.CODEC, "widgets");
    }

    @Override
    protected void apply(Map<Identifier, Widget> prepared, ResourceManager manager, Profiler profiler) {
        int it = 0;
        ENTRIES.clear();
        for (Map.Entry<Identifier, Widget> entry : prepared.entrySet()) {
        ...
        ResourceManagerHelper.get(ResourceType.CLIENT_RESOURCES)
                .registerReloadListener(new IdentifiableResourceReloadListener() {
                    ...
                    public CompletableFuture<Void> reload(Synchronizer synchronizer, ResourceManager manager,
                        ...
                        return loader.reload(synchronizer,
                                manager,
                                prepareExecutor,
                                applyExecutor);
                    }
